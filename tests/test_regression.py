...
class TestLinearRegressionSample:
    ...
    def test_method(self, model_options):
        ...
        LinearRegression.sample(model = model,
    ...
    def test_raises_type_error(self, linear_regression_sample_type_error):
        with raises(TypeError):
            LinearRegression.sample(model = linear_regression_sample_type_error['model'],
                                    n_iterations = linear_regression_sample_type_error['n_iterations'],
    ...
    def test_raises_value_error(self, linear_regression_sample_value_error):
        with raises(ValueError):
            LinearRegression.sample(model = linear_regression_sample_value_error['model'],
                                    n_iterations = linear_regression_sample_value_error['n_iterations'],
