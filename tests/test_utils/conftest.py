...
utils_matrices_to_frame_type_error_1 = [
    type_to_check for type_to_check in types_to_check
    if not isinstance(type_to_check, dict)
]

utils_matrices_to_frame_type_error_2 = [
    {'a': type_to_check} for type_to_check in types_to_check
    if not isinstance(type_to_check, np.ndarray)
]
...
utils_dot_product_type_error_1 = [
    {'data': type_to_check, 'regressors': {}}
...
utils_dot_product_type_error_2 = [
    {
        'data': pd.DataFrame(columns=['a', 'b'], index=[0]),
        'regressors': type_to_check
    } for type_to_check in types_to_check
    if not isinstance(type_to_check, dict)
]
...
utils_dot_product_type_error_3 = [
    {
        'data': pd.DataFrame(columns=['a', 'b'], index=[0]),
        'regressors': {'a': type_to_check}
    } for type_to_check in types_to_check
    if not isinstance(type_to_check, int)
    and not isinstance(type_to_check, float)
]
