...
@fixture(params = [{'data': 'data', 'response_variable': 'response_variable'},
                   {'data': 1, 'response_variable': 'response_variable'},
                   {'data': 1.1, 'response_variable': 'response_variable'},
                   {'data': True, 'response_variable': 'response_variable'},
                   {'data': (0, 1), 'response_variable': 'response_variable'},
                   {'data': [0, 1], 'response_variable': 'response_variable'},
                   {'data': {0, 1}, 'response_variable': 'response_variable'},
                   {'data': None, 'response_variable': 'response_variable'},
                   {'data': pd.DataFrame(), 'response_variable': 1},
                   {'data': pd.DataFrame(), 'response_variable': 1.1},
                   {'data': pd.DataFrame(), 'response_variable': True},
                   {'data': pd.DataFrame(), 'response_variable': (0, 1)},
                   {'data': pd.DataFrame(), 'response_variable': [0, 1]},
                   {'data': pd.DataFrame(), 'response_variable': {0, 1}},
                   {'data': pd.DataFrame(), 'response_variable': None}])
def model_set_data_type_error(request):
    return request.param


@fixture(params = [{'data': pd.DataFrame(), 'response_variable': 'response_variable'},
                   {'data': pd.DataFrame(columns = ['not_response_variable'], index = [0]), 'response_variable': 'response_variable'}])
...
@fixture(params = [{'posteriors': 'posteriors', 'lags': 30},
                   ...
                   {'posteriors': {'intercept': [0], 'variance': np.array([0])}, 'lags': 30},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': 'lags'},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': 1},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': 1.1},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': True},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': (0, 1)},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': {'30': 30}},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': {0, 1}},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': ['lag']},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [1.1]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [(0, 1)]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [[0, 1]]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [{0, 1}]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [{'lag': 1}]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'lags': [None]}])
...
@fixture(params = [{'posteriors': 'posteriors', 'alpha': 0.05, 'quantiles': [0.1, 0.9]},
                   ...
                   {'posteriors': {'intercept': [0], 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 'alpha', 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 2, 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': (0, 1), 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': [0, 1], 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': {0, 1}, 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': {'0': 1}, 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': None, 'quantiles': [0.1, 0.9]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': 'quantiles'},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': 1},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': 1.1},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': True},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': (0, 1)},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': {'0.1': 0.1}},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': {0, 1}},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': ['quantiles']},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [1]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [(0, 1)]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [[0, 1]]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [{0, 1}]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [{'quantiles': 1}]},
                   {'posteriors': {'intercept': np.array([0]), 'variance': np.array([0])}, 'alpha': 0.05, 'quantiles': [None]}])
